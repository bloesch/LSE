/*!
* @file 	FilterInertialOF.hpp
* @author 	Michael Blösch
* @date		10.10.2012
* @brief	VUKF Filter for legged robots
 */

#ifndef FILTERINERTIALOF_HPP_
#define FILTERINERTIALOF_HPP_
...
class Manager;
class StateInertialOF;
class PreNoiseInertialOF;
class MeasKinNoiseInertialOF;

/*! Observability Constrained Extended Kalman Filter */
class FilterInertialOF: public FilterBase{
public:public:
	 ...
	 */
	FilterInertialOF(Manager* pManager,const char* pFilename);
	/*! Destructor */
	virtual ~FilterInertialOF();
