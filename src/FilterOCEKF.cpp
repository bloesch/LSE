...
FilterOCEKF::~FilterOCEKF(){
}

void FilterOCEKF::update(const double& t){
...
void FilterOCEKF::filterState(InternState& x,const double& tEnd){
...
void FilterOCEKF::encUpdateState(InternState& x, const EncMeas& m){
...
void FilterOCEKF::loadParam(const char* pFilename){
	// Open parameter file
	...
	if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("Position").FirstChild("Init").Element();
		if (pElem){
			pElem->QueryDoubleAttribute("x", &xInit_.r_(0));
			pElem->QueryDoubleAttribute("y", &xInit_.r_(1));
			pElem->QueryDoubleAttribute("z", &xInit_.r_(2));
		}
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("Position").FirstChild("InitStd").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("Velocity").FirstChild("Init").Element();
		if (pElem){
			pElem->QueryDoubleAttribute("x", &xInit_.v_(0));
			pElem->QueryDoubleAttribute("y", &xInit_.v_(1));
			pElem->QueryDoubleAttribute("z", &xInit_.v_(2));
		}
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("Velocity").FirstChild("InitStd").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("Attitude").FirstChild("Init").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("Attitude").FirstChild("InitStd").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("AccelerometerBias").FirstChild("Init").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("AccelerometerBias").FirstChild("InitStd").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("GyroscopeBias").FirstChild("Init").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("GyroscopeBias").FirstChild("InitStd").Element();
		if (pElem){
		...
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("AccelerometerBias").Element();
		if (pElem){
			pElem->QueryIntAttribute("estimate", &mInt);
			mbEstimateAccBias_ = mInt;
		}
		pElem=hRoot.FirstChild("OCEKFSettings").FirstChild("GyroscopeBias").Element();
		if (pElem){
			pElem->QueryIntAttribute("estimate", &mInt);
